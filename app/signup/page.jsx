  ...
  async function handleSignup(event) {
    ...
    try {
      ...
      if (
        ...
        setError("Supabase is in demo mode. Click 'Explore Demo Workspace' below to start exploring!");
      } else {
    ...
    <main className="grid-bg flex min-h-screen items-center justify-center px-4 py-12">
      <section className="w-full max-w-md">
        ...
        <div className="glass-panel rounded-2xl border p-6 shadow-xl sm:p-8 space-y-5">
          ...
          {message && <p role="status" className="rounded-lg border border-emerald-500/30 bg-emerald-500/10 p-3 text-sm text-emerald-600">{message}</p>}
